                                ...
                                <div class="modal fade" id="Edit{{ $item->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('Admin.data-mobil.update', $item->id) }}"
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="nama" id="nama" type="text"
                                                            value="{{ $item->jenis_kendaraan }}" required readonly>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="col-form-label text-capitalize"
                                                            ...
                                                            deskripsi:</label>
                                                        <textarea class="form-control" name="deskripsi" id="deksripsi"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        @if ($item->foto)
                                                        <img id="edit-img-preview-{{ $item->id }}"
                                                            class="img-preview img-fluid mb-3 col-sm-5 d-block"
                                                            src="{{ asset('img/mobil/' . basename($item->foto)) }}"
                                                            alt="Preview Image">
                                                        @else
                                                        <img id="edit-img-preview-{{ $item->id }}"
                                                            class="img-preview img-fluid mb-3 col-md-6"
                                                            style="display: none;">
                                                        @endif
                                                        <input type="file"
                                                            onchange="previewImage(event, 'edit-img-preview-{{ $item->id }}')"
                                                            name="foto" id="foto-edit-{{ $item->id }}"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('Admin.data-mobil.delete', $item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger"
                                                        id="delete-record{{ $item->id }}">Ya, Hapus</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form action="{{ route('Admin.data-mobil.add') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <img id="add-img-preview" class="img-preview img-fluid mb-3 col-md-6"
                                        style="display: none;">
                                    <input type="file" onchange="previewImage(event, 'add-img-preview')" name="foto"
                                        id="foto-add" class="form-control" autocomplete="off" />
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">
