                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" name="nama" id="nama"
                                                                    type="text" value="{{ $item->nama }}" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="col-form-label text-capitalize"
                                                                    for="harga">masukkan
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img id="add-img-preview" class="img-preview img-fluid mb-3 col-md-6"
                                            style="display: none;">
                                        <input type="file" onchange="previewImage(event, 'add-img-preview')"
                                            name="foto" id="foto-add" class="form-control" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="modal-footer">
