    ...
    <div class="row">
        ...
        <div class="row">
                    ...
                    <div class="card-body text-center">
                        <div class="round-box">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <g>
                                    <path
                                        d="M62.8,24.8l-1.1-4.4c-1.3-5-5.9-8.4-11-8.4H13.3c-5.1,0-9.7,3.4-11,8.4L1.2,24.8C0.4,27.6,2.4,30,5,30h1v11.3
            ...
            c0,1.1-0.9,2-2,2h-1.3c-1.4-2.4-4-4-6.7-4s-5.3,1.6-6.7,4H26.7c-1.4-2.4-4-4-6.7-4s-5.3,1.6-6.7,4H12c-1.1,0-2-0.9-2-2V30h45V41.3z">
                        ...
                        <div class="parrten">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 448.057 448.057"
                    ...
                    <div class="card-body text-center">
                        <div class="round-box">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <g>
                                    <path
                                        d="M32,34c-9.9,0-18-8.1-18-18S22.1-2,32-2s18,8.1,18,18S41.9,34,32,34z M32,6c-5.5,0-10,4.5-10,10s4.5,10,10,10s10-4.5,10-10 S37.5,6,32,6z" />
                                    <path
                                        d="M32,38c-11.9,0-22,9.3-22,21c0,1.1,0.9,2,2,2h40c1.1,0,2-0.9,2-2C54,47.3,43.9,38,32,38z M12.6,57.6 c1.4-5.4,6.5-9.6,12.4-9.6h14c5.9,0,11,4.2,12.4,9.6H12.6z" />
                                </g>
                            </svg>
            ...
            C9.1,16.3,19.8,6.5,32,6.5S54.9,16.3,54.9,30.1S44.2,54.1,32,54.1z" />
                                    <path
                                        d="M22.1,23.8h-5.7c-0.5,0-1,0.4-1,1c0,0.5,0.4,1,1,1h5.7c0.5,0,1-0.4,1-1C23.1,24.2,22.7,23.8,22.1,23.8z" />
                                    <path
                                        d="M32.3,23.8H25c-0.5,0-1,0.4-1,1c0,0.5,0.4,1,1,1h7.3c0.5,0,1-0.4,1-1C33.3,24.2,32.9,23.8,32.3,23.8z" />
                                    <path
                                        d="M42.6,23.8H35c-0.5,0-1,0.4-1,1c0,0.5,0.4,1,1,1h7.6c0.5,0,1-0.4,1-1C43.6,24.2,43.1,23.8,42.6,23.8z" />
                                    <path
                                        d="M22.1,33.4h-5.7c-0.5,0-1,0.4-1,1c0,0.5,0.4,1,1,1h5.7c0.5,0,1-0.4,1-1C23.1,33.8,22.7,33.4,22.1,33.4z" />
                                    <path
                                        d="M32.3,33.4H25c-0.5,0-1,0.4-1,1c0,0.5,0.4,1,1,1h7.3c0.5,0,1-0.4,1-1C33.3,33.8,32.9,33.4,32.3,33.4z" />
                                    <path
                                        d="M42.6,33.4H35c-0.5,0-1,0.4-1,1c0,0.5,0.4,1,1,1h7.6c0.5,0,1-0.4,1-1C43.6,33.8,43.1,33.4,42.6,33.4z" />
                                </g>
                            </svg>
