                    ...
                    <div class="inspection-column v2 col-lg-7 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="description-sec">
                                ...
                                <ul class="des-list">
                                    <li><a href="#"><img
                                                src="{{ asset('landing/images/resource/book1-1.svg') }}">View Vin
                                            Report</a></li>
                                    <li class="two"><a href="#"><img
                                                src="{{ asset('landing/images/resource/book1-2.svg') }}">Car Brochure</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="testimonial-slider">
            ...
            <div class="cars-section-three">
                <div class="boxcar-container">
                    <div class="boxcar-title wow fadeInUp">
                        ...
                        <a href="/" class="btn-title">View All<svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="car-block-three col-lg-3 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <div class="btn-box">
                                            <span>Rp. {{ number_format($item->harga) }} Per hari</span><br>
                                            <a href="/user/detail-product/{{ $item->id }}" class="details">View
                                                Details<svg xmlns="http://www.w3.org/2000/svg" width="14"
