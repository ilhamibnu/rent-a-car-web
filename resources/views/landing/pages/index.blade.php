                                ...
                                <div class="btn-box">
                                    ...
                                    @if ($tanggal_keluar == '0' && $tanggal_kembali == '0')
                                        <a href="/user/detail-product/{{ $data->id }}" class="details">Lihat
                                            Rincian<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <a href="/user/detail-product/{{ $data->id }}/{{ $tanggal_keluar }}/{{ $tanggal_kembali }}"
                                                    class="details">Lihat Rincian<svg xmlns="http://www.w3.org/2000/svg"
            ...
            <nav class="wow fadeInUp" data-wow-delay="100ms">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-home-tab2" data-bs-toggle="tab" data-bs-target="#nav-home2"
                        type="button" role="tab" aria-controls="nav-home2" aria-selected="true">All</button>
                    <button class="nav-link" id="nav-profile-tab2" data-bs-toggle="tab" data-bs-target="#nav-profile2"
                        type="button" role="tab" aria-controls="nav-profile2" aria-selected="false">Mobil</button>
                    <button class="nav-link" id="nav-contact-tab2" data-bs-toggle="tab" data-bs-target="#nav-contact2"
                        type="button" role="tab" aria-controls="nav-contact2" aria-selected="false">Motor</button>
                </div>
            </nav>
        </div>
