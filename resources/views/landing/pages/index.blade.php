        ...
        <div class="row">
            ...
            <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                <div class="inner-box wow fadeInUp">
                    <div class="image-box">
                        <figure class="image"><a href="inventory-list-01.html"><img src="{{ asset('landing/images/resource/brand-1.png') }}" alt=""></a>
                        </figure>
                    </div>
            ...
            <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                <div class="inner-box wow fadeInUp" data-wow-delay="100ms">
                    <div class="image-box">
                        <figure class="image"><a href="inventory-list-01.html"><img src="{{ asset('landing/images/resource/brand-2.png') }}" alt=""></a>
                        </figure>
                    </div>
                    <div class="content-box">
            ...
            <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
                    <div class="image-box">
                        <figure class="image"><a href="inventory-list-01.html"><img src="{{ asset('landing/images/resource/brand-3.png') }}" alt=""></a>
                        </figure>
                    </div>
                    <div class="content-box">
            ...
            <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                <div class="inner-box wow fadeInUp" data-wow-delay="300ms">
                    <div class="image-box">
                        <figure class="image"><a href="inventory-list-01.html"><img src="{{ asset('landing/images/resource/brand-4.png') }}" alt=""></a>
                        </figure>
                    </div>
                    <div class="content-box">
            ...
            <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                <div class="inner-box wow fadeInUp" data-wow-delay="400ms">
                    <div class="image-box">
                        <figure class="image"><a href="inventory-list-01.html"><img src="{{ asset('landing/images/resource/brand-5.png') }}" alt=""></a>
                        </figure>
                    </div>
                    <div class="content-box">
            ...
            <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                <div class="inner-box wow fadeInUp" data-wow-delay="500ms">
                    <div class="image-box">
                        <figure class="image"><a href="inventory-list-01.html"><img src="{{ asset('landing/images/resource/brand-6.png') }}" alt=""></a>
                        </figure>
                    </div>
                    <div class="content-box">
                    ...
                    <div class="content-box">
                        ...
                        <div class="btn-box">
                            ...
                            <a href="/user/detail-product/{{ $data->id }}" class="details">View
                                Details<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
        ...
        <div class="tab-pane fade show active" id="nav-home2" role="tabpanel" aria-labelledby="nav-home-tab2">
            <div class="row car-slider slider-layout-1" data-preview="2.3">
                <div class="car-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="#"><img src="{{ asset('landing/images/resource/shop1-1.jpg') }}" alt=""></a>
                            </figure>
                            <span>Low Mileage</span>
                ...
                <div class="car-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="#"><img src="{{ asset('landing/images/resource/shop1-2.jpg') }}" alt=""></a>
                            </figure>
                            <a href="#" class="icon-box">
                                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_2806_1274)">
    ...
    <div class="boxcar-container">
        ...
        <ul class="nav nav-tabs wow fadeInUp" data-wow-delay="100ms" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">New Cars For
                    Sale</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Used Cars For
                    Sale</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Browse By
                    Type</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Browse By
    ...
    <div class="boxcar-container">
        ...
        <div class="row">
            ...
            <div class="blog-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box wow fadeInUp">
                    <div class="image-box">
                        <figure class="image"><a href="blog-single.html"><img src="{{ asset('landing/images/resource/blog-1.jpg') }}" alt=""></a>
                        </figure>
            ...
            <div class="blog-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box wow fadeInUp" data-wow-delay="100ms">
                    <div class="image-box">
                        <figure class="image"><a href="blog-single.html"><img src="{{ asset('landing/images/resource/blog-2.jpg') }}" alt=""></a>
                        </figure>
                        <span class="date">news</span>
                    </div>
                    <div class="content-box">
            ...
            <div class="blog-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
                    <div class="image-box">
                        <figure class="image"><a href="blog-single.html"><img src="{{ asset('landing/images/resource/blog-3.jpg') }}" alt=""></a>
                        </figure>
                        <span class="date">news</span>
                    </div>
                    <div class="content-box">
