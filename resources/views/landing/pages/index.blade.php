                                ...
                                <form action="/" method="GET">
                                    ...
                                    <div class="row">
                                        <div class="text-center">
                                            <input type="date" class="form-control" id="future-date-1"
                                                name="tanggal_keluar"
                                    ...
                                    <div class="row">
                                        <div class="text-center">
                                            <input type="date" class="form-control" id="future-date-2"
    ...
    <section class="boxcar-brand-section section-radius-top bg-1">
        <div class="boxcar-container">
            <div class="boxcar-title">
                ...
                <a href="inventory-list-01.html" class="btn-title">Show All Brands<svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="row">
                ...
                <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                    <div class="inner-box wow fadeInUp">
                        <div class="image-box">
                            <figure class="image"><a href="inventory-list-01.html"><img
                                        src="{{ asset('landing/images/resource/brand-1.png') }}" alt=""></a>
                            </figure>
                        </div>
                ...
                <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                    <div class="inner-box wow fadeInUp" data-wow-delay="100ms">
                        <div class="image-box">
                            <figure class="image"><a href="inventory-list-01.html"><img
                                        src="{{ asset('landing/images/resource/brand-2.png') }}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-box">
                ...
                <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                    <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
                        <div class="image-box">
                            <figure class="image"><a href="inventory-list-01.html"><img
                                        src="{{ asset('landing/images/resource/brand-3.png') }}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-box">
                ...
                <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                    <div class="inner-box wow fadeInUp" data-wow-delay="300ms">
                        <div class="image-box">
                            <figure class="image"><a href="inventory-list-01.html"><img
                                        src="{{ asset('landing/images/resource/brand-4.png') }}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-box">
                ...
                <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                    <div class="inner-box wow fadeInUp" data-wow-delay="400ms">
                        <div class="image-box">
                            <figure class="image"><a href="inventory-list-01.html"><img
                                        src="{{ asset('landing/images/resource/brand-5.png') }}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-box">
                ...
                <div class="cars-block style-1 col-lg-2 col-md-6 col-sm-6">
                    <div class="inner-box wow fadeInUp" data-wow-delay="500ms">
                        <div class="image-box">
                            <figure class="image"><a href="inventory-list-01.html"><img
                                        src="{{ asset('landing/images/resource/brand-6.png') }}" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-box">
        ...
        <div class="boxcar-container">
            <div class="boxcar-title-three wow fadeInUp">
                ...
                <form class="form-box">
                    ...
                    <div class="form_boxes">
                        <a href="#" title="" class="filter-btn filter-popup"><img src=""
                                alt="" /> More Filters</a>
                    </div>
                </form>
                    ...
                    <div class="car-block-four col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="inner-box">
                            ...
                            <div class="content-box">
                                ...
                                <div class="btn-box">
                                    <span>Rp. {{ number_format($data->harga) }} Per day</span><br>
                                    ...
                                    @if ($tanggal_keluar == '0' && $tanggal_kembali == '0')
                                        <a href="/user/detail-product/{{ $data->id }}" class="details">View
                                            Details<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form action="/user/booking" method="post" class="pt-2">
                                                    ...
                                                    <input type="hidden" name="tanggal_keluar"
                                                        value="{{ $tanggal_keluar }}">
                                                    <input type="hidden" name="tanggal_kembali"
                                                        value="{{ $tanggal_kembali }}">
                                                    <button type="submit"
                                                        class="btn btn-primary text-light text-capitalize">booking
                                                    </button>
                                                </form>
                                            </div>
                                            <div class="col-md-6">
                                                <a href="/user/detail-product/{{ $data->id }}/{{ $tanggal_keluar }}/{{ $tanggal_kembali }}"
                                                    class="details">View Details<svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="boxcar-container">
            ...
            <div class="row">
                ...
                <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp">
                        <div class="icon-box"><svg xmlns="http://www.w3.org/2000/svg" width="51" height="60"
                                viewbox="0 0 51 60" fill="none">
                        ...
                        <div class="content-box">
                            ...
                            <div class="text">Our stress-free finance department that can find financial solutions to
                                save you money.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="100ms">
                        <div class="icon-box"><svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                viewbox="0 0 60 60" fill="none">
                                <path d="M30 2.34375V7.03125" stroke="#FF5CF4" stroke-width="3" stroke-miterlimit="10"
                                ...
                                <path d="M17.3849 29.5312H42.6151" stroke="#405FF2" stroke-width="3"
                                    stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M25.3125 24.8438L30 29.5312L34.6875 24.8438" stroke="#405FF2" stroke-width="3"
                                    stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M30 43.5938V29.7306" stroke="#405FF2" stroke-width="3" stroke-miterlimit="10"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </div>
                        <div class="content-box">
            ...
            <nav class="wow fadeInUp" data-wow-delay="100ms">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-contact-tab2" data-bs-toggle="tab" data-bs-target="#nav-contact2"
                        type="button" role="tab" aria-controls="nav-contact2"
                        ...
                        <div class="inner-box">
                            ...
                            <div class="content-box">
                                ...
                                <div class="btn-box">
                                    <span>$789</span>
                                    <small>$399</small>
                                    <a href="#" class="details">View Details<svg
                ...
                <div class="row car-slider slider-layout-1" data-preview="2.3">
                    <div class="car-block-two col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img
                                            src="{{ asset('landing/images/resource/shop1-1.jpg') }}"
                                            alt=""></a></figure>
                                <span>Low Mileage</span>
                                <a href="#" class="icon-box">
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                    ...
                    <div class="car-block-two col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img
                                            src="{{ asset('landing/images/resource/shop1-2.jpg') }}"
                                            alt=""></a></figure>
                                <a href="#" class="icon-box">
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="cars-section">
        <div class="boxcar-container">
            <div class="boxcar-title wow fadeInUp">
                ...
                <a href="#" class="btn-title">View More<svg xmlns="http://www.w3.org/2000/svg" width="14"
                        height="14" viewbox="0 0 14 14" fill="none">
                        <g clip-path="url(#clip0_601_3199)">
                            <path
                                d="M13.6109 0H5.05533C4.84037 0 4.66643 0.173943 4.66643 0.388901C4.66643 0.603859 4.84037 0.777802 5.05533 0.777802H12.6721L0.113697 13.3362C-0.0382246 13.4881 -0.0382246 13.7342 0.113697 13.8861C0.18964 13.962 0.289171 14 0.388666 14C0.488161 14 0.587656 13.962 0.663635 13.8861L13.222 1.3277V8.94447C13.222 9.15943 13.3959 9.33337 13.6109 9.33337C13.8259 9.33337 13.9998 9.15943 13.9998 8.94447V0.388901C13.9998 0.173943 13.8258 0 13.6109 0Z"
            ...
            <ul class="nav nav-tabs wow fadeInUp" data-wow-delay="100ms" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                        type="button" role="tab" aria-controls="home" aria-selected="true">New Cars For
                        Sale</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                        type="button" role="tab" aria-controls="profile" aria-selected="false">Used Cars For
                        Sale</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                        type="button" role="tab" aria-controls="contact" aria-selected="false">Browse By
                        Type</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
            ...
            <div class="row">
                    ...
                    <div class="inner-box wow fadeInUp">
                        <div class="image-box">
                            <figure class="image"><a href="blog-single.html"><img
                                        src="{{ asset('landing/images/resource/blog-1.jpg') }}" alt=""></a>
                            </figure>
                ...
                <div class="blog-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="100ms">
                        <div class="image-box">
                            <figure class="image"><a href="blog-single.html"><img
                                        src="{{ asset('landing/images/resource/blog-2.jpg') }}" alt=""></a>
                            </figure>
                            <span class="date">news</span>
                        </div>
                        <div class="content-box">
                ...
                <div class="blog-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
                        <div class="image-box">
                            <figure class="image"><a href="blog-single.html"><img
                                        src="{{ asset('landing/images/resource/blog-3.jpg') }}" alt=""></a>
                            </figure>
                            <span class="date">news</span>
                        </div>
                        <div class="content-box">
                        ...
                        <div class="hover-img">
                            <svg xmlns="http://www.w3.org/2000/svg" width="110" height="110"
                                ...
                                <path
                                    ...
                                    stroke="#405FF2" stroke-width="5" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                                <path d="M63.1641 86.582H49.8433" stroke="#405FF2" stroke-width="5"
                                    stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path
                                ...
                                <path
                                    ...
                                    stroke="#FF5CF3" stroke-width="5" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                            </svg>
                        </div>
                    </div>
                        ...
                        <div class="hover-img">
                            <svg xmlns="http://www.w3.org/2000/svg" width="110" height="110"
                                ...
                                <path
                                    ...
                                    stroke="#FF5CF4" stroke-width="5" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                                <path
