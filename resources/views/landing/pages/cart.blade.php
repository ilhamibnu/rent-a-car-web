                                ...
                                <td>
                                    <div class="shop-cart-product">
                                        <div class="shop-product-cart-img">
                                            <img src="{{ asset('landing/images/resource/cart1.png') }}" alt="" />
                                        </div>
                                ...
                                <td>
                                    <form action="/user/cart/{{ $data->id }}" method="post">
                                        ...
                                        <button type="submit" class="remove-cart-item">
                                            <img src="{{ asset('landing/images/icons/remove.svg') }}" alt="" />
                                        </button>
                                    </form>
                                </td>
                            </tr>
        ...
        <div class="col-lg-3">
            <div class="cart-totals">
                ...
                <form action="/user/checkout" method="post">
                    @csrf
                    <button class="theme-btn-web">Proceed to Checkout <img src="images/arrow.svg" alt=""></button>
                </form>
                @endif
