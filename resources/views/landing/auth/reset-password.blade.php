            ...
            <div class="form-sec">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Ubah Kata Sandi</button>
                        ...
                        <div class="form-box">
                            ...
                            <form action="/user/reset-password" method="POST">
                                ...
                                <div class="form-submit">
                                    <button type="submit" class="theme-btn">Kirim Tautan Ubah Kata Sandi<img src="images/arrow.svg" alt="" />
                                    </button>
                                </div>
                            </form>
